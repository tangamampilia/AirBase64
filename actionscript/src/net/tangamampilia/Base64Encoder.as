...
package net.tangamampilia {
	...
	public class Base64Encoder {
		...
		private static const EXTENSION_ID : String = "net.tangamampilia.Base64Encoder";
		private static var _instance : Base64Encoder;
		...
		public static function getInstance() : Base64Encoder {
		...
		public static function encodeByteArray(data:ByteArray) : String {
			...
			if (!Base64Encoder.isSupported) return null;
			...
			if (Base64Encoder.isDesktopSimulator) {
				...
				base64 = native._context.call("Base64EncoderEncode", data) as String;
			}
		...
		public static function encodeBitmapData(data:BitmapData) : String {
			...
			if (Base64Encoder.isDesktopSimulator) {
				...
				var native:Base64Encoder =  Base64Encoder.getInstance();
				base64 = native._context.call("Base64EncoderEncode", bytes) as String;
			}
